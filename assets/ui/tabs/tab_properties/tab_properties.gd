...
const PROPERTY_CONTAINER := preload("res://assets/ui/tabs/tab_properties/container/property_container.tscn")
const STRING_FIELD := preload("res://assets/ui/tabs/tab_properties/field/string_field/string_field.tscn")
const COLOR_FIELD := preload("res://assets/ui/tabs/tab_properties/field/color_field/color_field.tscn")
const BOOL_FIELD := preload("res://assets/ui/tabs/tab_properties/field/bool_field/bool_field.tscn")
const FLOAT_FIELD := preload("res://assets/ui/tabs/tab_properties/field/float_field/float_field.tscn")
